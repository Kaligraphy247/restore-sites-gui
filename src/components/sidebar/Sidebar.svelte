...
<aside
    class="relative flex h-screen flex-col border-r bg-white text-neutral-900 transition-[width] duration-300 ease-in-out dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-50 overflow-hidden"
...
>
    ...
    >
        ...
        <button
            type="button"
            class="inline-flex h-8 w-8 items-center justify-center rounded-md border border-neutral-200 bg-white text-neutral-600 hover:bg-neutral-50 hover:text-neutral-900 active:bg-neutral-100 dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-300 dark:hover:bg-neutral-800 dark:hover:text-neutral-50"
    ...
    <!-- Footer / actions -->
    <div class="border-t px-2 py-2 dark:border-neutral-800">
