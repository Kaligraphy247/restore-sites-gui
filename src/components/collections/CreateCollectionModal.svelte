            ...
            <div class="flex-1 overflow-y-auto p-4 space-y-4">
                ...
                <div>
                    ...
                    <textarea
                        ...
                        class="w-full h-32 border border-neutral-300 dark:border-neutral-600 rounded-md px-3 py-2 resize-none bg-white dark:bg-neutral-700 text-neutral-900 dark:text-neutral-100 placeholder:text-neutral-400 dark:placeholder:text-neutral-500 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm"
                    ></textarea>
                    <div class="flex items-center justify-between text-xs text-neutral-500 dark:text-neutral-400 mt-1">
                        <span>
                            {#if sitesText.trim()}
                                {sites.length} sites detected
                            {:else}
                ...
                {:else if !sitesText.trim()}
                    <div class="text-center py-8 text-neutral-500 dark:text-neutral-400">
                        <p class="text-sm">Paste URLs above or add sites manually</p>
                        <button
                            onclick={showAddSiteForm}
